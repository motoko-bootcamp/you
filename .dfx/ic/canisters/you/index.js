...
import { idlFactory } from './you.did.js';
export { idlFactory } from './you.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_YOU;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./you.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the you canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./you.did.js")._SERVICE>}
 */
export const you = createActor(canisterId);
